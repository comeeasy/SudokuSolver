...
class Drawer:
    def __init__(self) -> None:
        ...
        self.number_imgs = [
            cv2.resize(
                cv2.imread(
                    f"images/numbers2/{number_name}.png", 
        ...
        for y in range(9):
            for x in range(9):
                if sudoku_mat[y][x] == 0:
                    ...
                    sudoku_grid = sudoku_img[SUDOKU_GRID_WIDTH*y+(SUDOKU_GRID_MARGIN//2) : SUDOKU_GRID_WIDTH*(y+1)-(SUDOKU_GRID_MARGIN//2),\
                    ...
                    sudoku_img[SUDOKU_GRID_WIDTH*y+(SUDOKU_GRID_MARGIN//2) : SUDOKU_GRID_WIDTH*(y+1)-(SUDOKU_GRID_MARGIN//2),\
                            SUDOKU_GRID_WIDTH*x+(SUDOKU_GRID_MARGIN//2) : SUDOKU_GRID_WIDTH*(x+1)-(SUDOKU_GRID_MARGIN//2)]\
